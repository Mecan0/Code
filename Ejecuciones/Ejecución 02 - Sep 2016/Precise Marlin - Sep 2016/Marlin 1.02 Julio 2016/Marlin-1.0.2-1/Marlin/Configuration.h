...
#define STRING_VERSION_CONFIG_H __DATE__ "29-Jun-2016" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Manuel Palacios)" // Who made the changes.
...
// La ultima medición ha sido en verano con 30 º
...
#define INVERT_E0_DIR true   // Titan //for direct drive extruder v9 set to true, for geared extruder set to false
...
#define DEFAULT_XYJERK                10.0  // 20 // (mm/sec)
