...
#define STRING_VERSION_CONFIG_H __DATE__ "6-12-2013 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Mecano, Marlin para PowerCode)" // Who made the changes.
...
// Ultimaker
    #define  DEFAULT_Kp 18.87 //22.2
    #define  DEFAULT_Ki 1.11 //1.08
    #define  DEFAULT_Kd 80.37 //114
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.8,80.8,4000,910}  
...
#define ABS_PREHEAT_HPB_TEMP 86
